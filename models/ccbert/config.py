...
print(DATA_FILE.format('train'))
parser.add_argument("--train_file_path", default='/media/data/thanhnb/dataset1/Copying-enhanced-CodeBERT/models/ccbert/data/train.csv', type=str)
parser.add_argument("--val_file_path", default='/media/data/thanhnb/dataset1/Copying-enhanced-CodeBERT/models/ccbert/data/valid.csv', type=str)
parser.add_argument("--test_file_path", default='/media/data/thanhnb/dataset1/Copying-enhanced-CodeBERT/models/ccbert/data/test.csv', type=str)
...
# dataset related
parser.add_argument("--max_src_len", default=256, type=int)
...
# parser.add_argument("--model_name", default="microsoft/unixcoder-base-nine", type=str)
parser.add_argument("--model_name", default="distilroberta-base", type=str)
...
parser.add_argument("--eval_interval", default=450000, type=int)
